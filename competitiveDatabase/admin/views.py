...
conn = MySQLdb.connect(host="rahilhastu.mysql.pythonanywhere-services.com",user='rahilhastu',passwd='tOAbfKL=0Is_>1ta',db='rahilhastu$competitiveDatabase')
cur = conn.cursor()
# nyzgi9-Xaskef-tagpow
